...
const SUGGESTED_TEMPLATES: Record<keyof MessageLibraryType, string[]> = {
    ...
    product: [
        "um acompanhamento completo — da estratégia à entrega do conteúdo — para negócios locais que querem crescer e faturar {{promessa}}.",
        "um serviço que cuida do seu marketing do início ao fim, ajudando negócios físicos a aumentarem seu faturamento {{promessa}}.",
        "uma assessoria que analisa seu posicionamento, seus serviços e seu público — e constrói a imagem profissional que vai te ajudar a faturar {{promessa}}.",
        "um trabalho estratégico e prático de marketing para negócios locais alcançarem {{promessa}}.",
        "um método que cuida de tudo — do planejamento à execução — para negócios locais que querem chegar a {{promessa}}.",
        "uma estratégia completa de marketing que ajuda negócios físicos a construírem autoridade e faturarem {{promessa}}.",
        "um processo que analisa seu negócio, define o posicionamento certo e atrai os clientes ideais para você faturar {{promessa}}.",
        "um trabalho que vai da estratégia à entrega do conteúdo, focado em gerar resultado financeiro real — {{promessa}}.",
        "uma forma de trabalhar que une planejamento estratégico e produção de conteúdo para negócios locais faturarem {{promessa}}.",
        "um acompanhamento que transforma o posicionamento do seu negócio em vendas reais, com faturamento {{promessa}}.",
        "uma metodologia que identifica o que funciona para o seu negócio e executa do início ao fim — gerando {{promessa}}.",
        "um serviço que cuida da imagem, da estratégia e do conteúdo do seu negócio local para você faturar {{promessa}}.",
        "um modelo de trabalho focado em atrair o cliente certo e converter em vendas — para negócios físicos que querem faturar {{promessa}}.",
        "uma assessoria que pega seu negócio do ponto em que está e estrutura tudo para você crescer e faturar {{promessa}}.",
        "uma assessoria que estrutura do zero o seu marketing — estratégia, posicionamento e conteúdo — para negócios locais faturarem {{promessa}}.",
        "um serviço que cuida de tudo que envolve sua presença digital, com foco em atrair clientes e aumentar o faturamento {{promessa}}.",
        "um trabalho que define como seu negócio deve se posicionar, quem deve atrair e como converter isso em vendas — chegando a {{promessa}}.",
        "uma metodologia completa de marketing para negócios físicos que querem parar de depender de indicação e faturar {{promessa}}.",
        "um processo que vai do diagnóstico do seu negócio até a entrega do conteúdo pronto — projetado para gerar {{promessa}}.",
        "uma assessoria que transforma a identidade do seu negócio em um ativo que atrai clientes e gera {{promessa}} de forma consistente.",
        "um acompanhamento que entrega estratégia e execução juntos — sem você precisar se preocupar com marketing — gerando {{promessa}}.",
        "um modelo de assessoria que analisa seu mercado, define seu diferencial e produz conteúdo focado em vendas para você faturar {{promessa}}.",
        "uma forma de trabalhar que cuida da imagem, do discurso e da presença digital do seu negócio para atrair o cliente certo e faturar {{promessa}}.",
        "um trabalho que pega tudo que está no seu negócio e transforma em posicionamento estratégico para você faturar {{promessa}}.",
        "uma assessoria que entende o seu mercado e constrói uma presença digital que converte — pensada para negócios que querem chegar a {{promessa}}.",
        "um processo de marketing que começa pelo seu negócio, não pelo algoritmo — e que está gerando {{promessa}} para negócios locais.",
    ],
    triggers: [
